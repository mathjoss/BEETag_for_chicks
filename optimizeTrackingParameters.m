...
%save images 
for ii=[4001:(4000+nframes/2), 25001:(25000+nframes/2)]
    img = read(vid, ii);
...
namevideooutput = strcat('C:\Users\bastien.lemaire\Desktop\videos\bdelete_this_after_optimizing_', num2str(chick_number), num2str(i), '.avi') ;
