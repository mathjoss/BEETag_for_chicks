...
%locates optical tags and spits out regionprops info for all tags
    ...
    for i=1:numel(R)     
        corners = R(i).corners;
        if (any(any(isnan(corners))==1)) || any(any(isinf(corners))==1)
            corners(1,1) = 30.8913 ; corners(1,2) = 44.0364 ; corners(1,3) = 35.3926 ; corners(1,4) = 26.9004 ;
            corners(2,1) = 783.6453 ; corners(2,2) = 787.7176 ; corners(2,3) = 794.4791 ; corners(2,4) = 790.1509 ;
        end
