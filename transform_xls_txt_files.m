...
% read excel file
xlsfile = '\\cimec-storage\gioval\projects\categorization_tracking\video_analysis\sessions_settings_ethovision_matlab_procedure1.7_1.8.xlsx';
...
%for chick_number = [86]
    ...
    % write the file
    outputfile_name = strcat('C:\Users\bastien.lemaire\Desktop\Beetag\txtfiles_chicks\chick', num2str(chick_number), '.txt') ;
